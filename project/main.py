...
class MainWidget(QWidget):
    ...
    def create_login_page(self):
        ...
        self.video_capture_widget = VideoCaptureWidget(back_button)
        buttons=QHBoxLayout()
...
class VideoCaptureWidget(QWidget):
    ...
    def proceding(self,data):
        self.status_label.setText("Welcome "+data)
        self.stop_video()
        QTimer.singleShot(2000,lambda: self.status_label.setText("Proceding to Homepage"))
        QTimer.singleShot(3000,lambda: self.homesetup())
