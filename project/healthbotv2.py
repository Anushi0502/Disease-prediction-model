...
class DiseasePredictionApp(QWidget):
    ...
    def init_ui(self):
        ...
        predict_button.setStyleSheet("background-color: #4CAF50; color: white; border-radius: 10px; font-size: 32px;")
        ...
        close_button.setStyleSheet("background-color: #f44336; color: white; border-radius: 10px; font-size: 32px;")
        ...
        result_label.setStyleSheet("font-size: 32px; font-weight: bold; color: #1a1a1a;")
        result_layout.addWidget(result_label)

        self.result_text = QTextEdit()
        self.result_text.setReadOnly(True)
        self.result_text.setStyleSheet("background-color: #f5f5f5; border: 1px solid #ccc; font-size: 32px;")
        result_layout.addWidget(self.result_text)

        layout.addLayout(result_layout)

        self.status_bar = QStatusBar()
        self.status_bar.setStyleSheet("font-size: 32px; color: #1a1a1a;")  # Status bar font size
    ...
    def setup_combo_box(self, layout, label_text, options):
        ...
        label.setStyleSheet("font-size: 32px; color: #555;")
        combo_box = QComboBox()
        combo_box.setStyleSheet("font-size: 32px; background-color: #f5f5f5; border: 1px solid #ccc;")
...
if __name__ == "__main__":
    ...
    apply_stylesheet(app, theme='bright_red.xml')  # Apply light theme
